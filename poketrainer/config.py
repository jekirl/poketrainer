...
class Config(object):
    ...
    def __init__(self, config, cli_args):
        ...
        self.pokeball_hitrate = config.get("CAPTURE", {}).get("POKEBALL_HITRATE", 10)
        self.pokeball_spinrate = config.get("CAPTURE", {}).get("POKEBALL_SPINRATE", 10)
        self.pokeball_min_accuracy = config.get("CAPTURE", {}).get("POKEBALL_MIN_ACCURACY", 10)
