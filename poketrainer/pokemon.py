...
class Pokemon(object):
    ...
    def __init__(self, pokemon_data, player_level=0,
        ...
        self.candy_needed_to_upgrade = 0
        self.dust_needed_to_upgrade = 0
    ...
    def set_max_cp(self, max_tcpm):
        ...
        self.candy_needed_to_upgrade = POKEMON_LVL_DATA[self.cpm_total].candy_to_power_up
        self.dust_needed_to_upgrade = POKEMON_LVL_DATA[self.cpm_total].stardust_to_power_up
